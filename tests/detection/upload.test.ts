...
describe('Upload Module', () => {
  ...
  describe('getSignedUrl', () => {
    it('should get a signed URL successfully', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/api/files/aws-presigned', {
    ...
    it('should handle RealityDefenderError errors', async () => {
      ...
      await expect(getSignedUrl(mockClient, 'test-file.jpg')).rejects.toThrow(error);
    });
    ...
    it('should handle generic errors', async () => {
      ...
      await expect(getSignedUrl(mockClient, 'test-file.jpg')).rejects.toThrow(
        'Failed to get signed URL: Network error'
      );
    });
  });
  ...
  describe('uploadToSignedUrl', () => {
    ...
    it('should handle RealityDefenderError errors', async () => {
      ...
      await expect(
        uploadToSignedUrl(mockClient, 'https://example.com/upload', '/path/to/file')
  ...
  describe('uploadFile', () => {
    ...
    it('should handle errors during signed URL request', async () => {
      ...
      await expect(
        uploadFile(mockClient, { filePath: '/path/to/test-file.jpg' })
      ).rejects.toThrow();
    });
